...
echo "   vault kv put secret/platform/cloudflare api_token=<YOUR_CF_TOKEN>"
echo "   (token needs Zone:DNS:Edit + Zone:Zone:Read permissions for cryptophys.work)"
echo "   This is required for cert-manager DNS-01 challenge (20-certificates wave)"
